...
namespace Dev_proc.Migrations
{
    ...
    [Migration("20220624163826_UpdatedCompanyIntern")]
    partial class UpdatedCompanyIntern
    {
            ...
            modelBuilder.Entity("Dev_proc.Models.Data.StudentCompanyIntern", b =>
                {
                    ...
                    b.ToTable("StudentCompanyInterns");
                });
            ...
            modelBuilder.Entity("Dev_proc.Models.Data.StudentCompanyIntern", b =>
                {
                    ...
                    b.HasOne("Dev_proc.Models.Identity.User", "Student")
                        .WithOne("StudentCompanyIntern")
                        .HasForeignKey("Dev_proc.Models.Data.StudentCompanyIntern", "StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CompanyIntern");
            ...
            modelBuilder.Entity("Dev_proc.Models.CompanyModels.Company", b =>
                {
                    ...
                    b.Navigation("StudentCompanyIntern");
                });
